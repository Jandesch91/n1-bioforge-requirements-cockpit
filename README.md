...
> Phase 6 — CHANGES REQUIRED; begrensde correcties lopen<br>
> **Grens:** De onafhankelijke review op b197abc vroeg vier begrensde correcties; niets is goedgekeurd of geadopteerd<br>
...
| 4R | Requirements/Test Designer | ❌ Changes required | Twee bevindingen: één blokkerend (de test van REQ-AUT-001 verbruikt gedrag dat pas veel later wordt bewezen) en één belangrijke (REQ-MUI-009 vraagt een besturingselement uit REQ-MUI-010). Beide zijn begrensd te corrigeren. |
