...
> Phase 6R5 — CHANGES REQUIRED; begrensde correctie klaar, verse review volgt<br>
> **Grens:** Phase 4R en Phase 5R zijn compleet en technisch degelijk; de enige R6R5-001-boekhoudingscorrectie is voltooid in deze correctiecommit<br>
> **Wat de mens nu doet:** Geen actie nodig vóór de verse review; menselijke adoptie volgt alleen na APPROVED op de ongewijzigde correctiecommit.<br>
> **Volgende toegestane actie:** Laat één andere verse onafhankelijke reviewer de ongewijzigde correctiecommit beoordelen nadat de orchestrator de exacte SHA heeft gebonden.
...
| 6 | Independent Reviewer | ❌ Changes required | 06R5 gaf CHANGES REQUIRED op exact SHA 8c17d16. De enige begrensde current-state-boekhoudingsbevinding R6R5-001 is in deze correctiecommit gecorrigeerd; requirements en deliveryplan zijn compleet en hoeven niet te worden geregenereerd. |
...
| 16 | `GATE` | Eén integraal en onafhankelijk goedgekeurd planningspakket | `alle actieve Release-1-rijen`<br>`traceability`<br>`Phase-5R-plan`<br>`Phase-7-adoptieprocedure` | ❌ Changes required | Fresh Independent Reviewer<br>Nog geen verse taak | Laat één andere verse onafhankelijke reviewer de ongewijzigde correctiecommit beoordelen nadat de orchestrator de exacte SHA heeft gebonden. |
