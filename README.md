...
> Phase 6 — tweede uitspraak: vier begrensde punten<br>
> **Grens:** Alle eerdere bevindingen zijn bevestigd gesloten; vier nieuwe, niet-blokkerende punten worden nu gecorrigeerd<br>
> **Wat de mens nu doet:** Geen actie nodig; na de correcties volgt opnieuw een verse review en pas daarna uw adoptiebesluit.<br>
> **Volgende toegestane actie:** Corrigeer R6R3-001 in Phase 4R, daarna R6R3-002 en R6R3-004 in Phase 5R, en bied een SHA aan waarop de cockpit gelijkloopt (R6R3-003).
...
| 4R | Requirements/Test Designer | 🔵 Bezig | Eén rij (REQ-PLAT-070) heeft nog een mutant die een latere rij aanroept; die wordt begrensd gecorrigeerd. |
| 5R | Delivery Planner | ❌ Changes required | Drie kleine punten: de controle moet ook de negatieve testcel dekken, één validatiezin klopt niet, en het hervattingspunt noemt de verouderde uitspraak. |
