...
> Phase 4R C03 — gepauzeerd door Codex-gebruiksgrens<br>
> **Grens:** C01 en C02 zijn duurzaam gevalideerd; gedeeltelijke C03-output is verworpen en niet gecommit<br>
> **Wat de mens nu doet:** Hervat C03 later expliciet nadat de Codex-gebruiksgrens opnieuw is gecontroleerd.<br>
> **Volgende toegestane actie:** PAUSED — CODEX USAGE GUARD >= 90%. Start niets automatisch.
...
Chunk **`C03`** is actief. `C03` blijft de eerstvolgende kandidaat en mag pas na validatie starten. De roadmap gebruikt één verticale baan en toont de vaste dependencyvolgorde expliciet.
...
flowchart TB
    ...
    chunk_3["3 · C03 · ⏭ VOLGENDE<br/>Eén echte REACT-fase met een vroege live Ignition-procesweergave<br/>🟨 Wacht op mens / keuze"]
    ...
    current_marker["🟨 YOU ARE HERE<br/>C03<br/>Volgende: C03"]
    chunk_0 --> chunk_1 --> chunk_2 --> current_marker --> chunk_3 --> chunk_4 --> chunk_5 --> chunk_6 --> chunk_7 --> chunk_8 --> chunk_9 --> chunk_10 --> chunk_11 --> chunk_12
    classDef approved fill:#D9F2E1,stroke:#1B7F3A,color:#12351D,stroke-width:2px
...
| 4R | Requirements/Test Designer | 🟨 Wacht op mens / keuze | C01 en C02 zijn duurzaam gevalideerd; C03 is zonder canonieke output onderbroken bij de gebruiksgrens en vereist expliciete hervatting. |
...
| 3 | `C03` | Eén echte REACT-fase met een vroege live Ignition-procesweergave | `toepasselijke REQ-AUT-*`<br>`eerste-fase REQ-BC-*`<br>`row-specifieke live-view REQ-HMI-*` | 🟨 Wacht op mens / keuze | Requirements/Test Designer<br>phase4r-c03-20260910-01 | Wacht op expliciete menselijke hervatting; controleer dan eerst opnieuw beide gebruiksvensters en start één nieuwe verse C03-taak. |
