...
> Cockpit gereed voor menselijke inspectie; inhoudelijke Phase 4R-regeneratie is nog niet gestart<br>
> **Grens:** Na de goedgekeurde Phase-3R-correctie en vóór een nieuwe Phase 4R<br>
> **Wat de mens nu doet:** Gebruik de publieke cockpit om de planning te volgen. Geef afzonderlijk toestemming voordat inhoudelijke Phase-4R-correctie begint.<br>
> **Volgende toegestane actie:** Na nieuwe expliciete toestemming: maak per dependency-chunk een verse Requirements/Test Designer-taak voor volledige Phase-4R-regeneratie.

- Planning branch: `codex/release-1-reconciliation`
- Input-SHA: `ffbd9d83e5604cbb02a8f83046f717be9eea4450`
- Snapshot: `2026-09-09`
...
flowchart TB
    ...
    phase_4r["4R · Requirements/Test Designer<br/>❌ Changes required"]
...
Er is nu **geen requirementchunk actief**. De cockpitpublicatie is afgerond; `C01` is de eerstvolgende inhoudelijke chunk, maar start alleen na afzonderlijke toestemming. De roadmap gebruikt één verticale baan en toont de vaste dependencyvolgorde expliciet.
...
flowchart TB
    ...
    chunk_1["1 · C01 · ⏭ VOLGENDE<br/>Eén gedeelde taal en een lokale identity-providerbasis<br/>❌ Changes required"]
    chunk_2["2 · C02<br/>Reproduceerbare proceswaarden zonder control logic in Simulation<br/>❌ Changes required"]
    ...
    current_marker["🟨 YOU ARE HERE<br/>geen requirementchunk actief<br/>Volgende: C01"]
    ...
    class chunk_1,chunk_2,chunk_3,chunk_4,chunk_5,chunk_6,chunk_7,chunk_8,chunk_9,chunk_10,chunk_11 changes
...
| 4R | Requirements/Test Designer | ❌ Changes required | De bestaande 04R-package is bewijs voor regeneratie en geen adopteerbare baseline. |
...
| 1 | `C01` | Eén gedeelde taal en een lokale identity-providerbasis | `REQ-CTR-001..030`<br>`REQ-PLAT-063..064`<br>`nieuw IdP-groundwork-ID door Phase 4R toe te kennen` | ❌ Changes required | Requirements/Test Designer<br>Nog geen verse taak | Start na expliciete toestemming één verse Phase-4R-taak voor deze chunk. |
