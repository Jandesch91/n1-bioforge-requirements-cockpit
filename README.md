...
> **Grens:** De verse review is geregistreerd maar niet gestart; de laatste geldige SHA en alle correcties zijn veilig bewaard<br>
...
> **Volgende toegestane actie:** Controleer bij een nieuwe invocation eerst PAUSE en providergebruik; start daarna pas de geregistreerde verse review als alle vensters dit toestaan.
...
flowchart TB
    ...
    phase_6["6 · Independent Reviewer<br/>🟣 Onafhankelijke review · 🟨 Wacht op mens / keuze"]
...
| 6 | Independent Reviewer | 🟨 Wacht op mens / keuze | De twee begrensde 06R4-boekhoudingsbevindingen zijn gecorrigeerd. De nieuwe verse review op exact SHA 8c17d16 is geregistreerd maar niet gestart wegens de provider-gebruiksgrens. |
...
| 16 | `GATE` | Eén integraal en onafhankelijk goedgekeurd planningspakket | `alle actieve Release-1-rijen`<br>`traceability`<br>`Phase-5R-plan`<br>`Phase-7-adoptieprocedure` | 🟨 Wacht op mens / keuze | Independent Reviewer<br>phase6-20260915-05 | Start bij een verse invocation alleen na nieuwe PAUSE- en providergebruikchecks; een andere provider mag direct overnemen. |
