...
> Phase 6 — begrensde correcties klaar; verse review volgt<br>
> **Grens:** De twee begrensde governance- en cockpitcorrecties zijn voltooid; de requirements en het delivery-plan bleven ongewijzigd<br>
> **Wat de mens nu doet:** Geen actie nodig; wacht op de nieuwe verse review van de exact uitgelijnde SHA.<br>
> **Volgende toegestane actie:** Laat één andere verse reviewer de exact uitgelijnde SHA beoordelen. Phase 7 blijft geblokkeerd tot APPROVED plus expliciete menselijke adoptie.
...
| 6 | Independent Reviewer | ❌ Changes required | De twee begrensde 06R4-boekhoudingsbevindingen zijn gecorrigeerd; de geldende uitspraak blijft CHANGES REQUIRED totdat een andere verse reviewer de exact uitgelijnde SHA beoordeelt. |
...
| 16 | `GATE` | Eén integraal en onafhankelijk goedgekeurd planningspakket | `alle actieve Release-1-rijen`<br>`traceability`<br>`Phase-5R-plan`<br>`Phase-7-adoptieprocedure` | ❌ Changes required | Independent Reviewer<br>Nog geen verse taak | Bied de uitgelijnde exacte SHA aan één andere verse reviewer aan; registreer de uitspraak ongewijzigd. |
