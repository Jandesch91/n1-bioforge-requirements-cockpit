...
> Phase 4R C03 klaar — private overdracht gereed<br>
> **Grens:** C01, C02 en C03 zijn duurzaam gevalideerd; er is geen actieve schrijftask<br>
> **Wat de mens nu doet:** Laat de volgende uitvoerder de private overdracht lezen en de duurzame staat opnieuw controleren.<br>
> **Volgende toegestane actie:** Start daarna precies één verse Requirements/Test Designer voor C04; begin geen applicatie-implementatie.
...
Er is nu **geen requirementchunk actief**. `C04` is de eerstvolgende toegestane chunk. De roadmap gebruikt één verticale baan en toont de vaste dependencyvolgorde expliciet.
...
flowchart TB
    ...
    chunk_4["4 · C04 · ⏭ VOLGENDE<br/>Een ongeldige start server-side weigeren en begrijpelijk verklaren<br/>❌ Changes required"]
    ...
    current_marker["🟨 YOU ARE HERE<br/>geen requirementchunk actief<br/>Volgende: C04"]
...
| 4R | Requirements/Test Designer | 🟨 Wacht op mens / keuze | C01, C02 en C03 zijn duurzaam gevalideerd. C04 is de eerstvolgende inhoudstaak en is nog niet gestart. |
