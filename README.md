...
> Phase 4R C04 — verse requirementtaak actief<br>
> **Grens:** C01, C02 en C03 zijn duurzaam gevalideerd; C04 is gestart vanaf de duurzame C03-handoff<br>
> **Wat de mens nu doet:** Geen actie nodig; de orchestrator stopt zelf bij een menselijke of gebruiksgrens.<br>
> **Volgende toegestane actie:** Valideer en commit alleen geldige C04-output; start daarna pas een verse C05-taak.
...
Chunk **`C04`** is actief. `C05` blijft de eerstvolgende kandidaat en mag pas na validatie starten. De roadmap gebruikt één verticale baan en toont de vaste dependencyvolgorde expliciet.
...
flowchart TB
    ...
    chunk_4["4 · C04<br/>Een ongeldige start server-side weigeren en begrijpelijk verklaren<br/>🔵 Bezig"]
    chunk_5["5 · C05 · ⏭ VOLGENDE<br/>MES-schema rechtstreeks bewijzen en het daarna veilig toepassen en seeden<br/>❌ Changes required"]
    ...
    current_marker["🔵 YOU ARE HERE<br/>C04<br/>Volgende: C05"]
    chunk_0 --> chunk_1 --> chunk_2 --> chunk_3 --> current_marker --> chunk_4 --> chunk_5 --> chunk_6 --> chunk_7 --> chunk_8 --> chunk_9 --> chunk_10 --> chunk_11 --> chunk_12
    classDef approved fill:#D9F2E1,stroke:#1B7F3A,color:#12351D,stroke-width:2px
...
| 4R | Requirements/Test Designer | 🔵 Bezig | C01, C02 en C03 zijn duurzaam gevalideerd; één verse C04-taak is actief. |
...
| 4 | `C04` | Een ongeldige start server-side weigeren en begrijpelijk verklaren | `permissive/reject-subset van REQ-BC-*`<br>`bijbehorende process-eventcontracten` | 🔵 Bezig | Requirements/Test Designer<br>phase4r-c04-20260910-01 | Laat alleen de verse C04-taak de gedeclareerde private requirementsbestanden bijwerken en valideer daarna de volledige diff. |
